            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li><a href="tour-home.jsp">Home</a></li>
                            <li class="active"></li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
                    ...
                    <div class="row">        	
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 side-bar left-side-bar">
                            ...
                            <div class="side-bar-block booking-form-block">
                            	<h2 class="selected-price">${tours.price} <span>${tour.name}</span></h2>
                            	...
                            	<div class="booking-form">
                                    ...
                                    <form>
                                        ...
                                        <button class="btn btn-block btn-orange">Xác nhận tại chỗ</button>
                                    </form>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                            ...
                            <div class="detail-slider">
                                <div class="feature-slider">
                                    <div><img src="<c:url value="/images/tourHaLong11.jpg"/>" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<c:url value="/images/tourHaLong22.jpg"/>" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<c:url value="/images/tourHaLong33.jpg"/>" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<c:url value="/images/tourHaLong44.jpg"/>" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<c:url value="/images/TourHaLong55.jpg"/>" class="img-responsive" alt="feature-img"/></div>
                                </div><!-- end feature-slider -->
                            	
                                <div class="feature-slider-nav">
                                    <div><img src="<c:url value="/images/tourHaLong111.jpg"/>" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<c:url value="/images/tourHaLong222.jpg"/>" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<c:url value="/images/tourHaLong333.jpg"/>" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<c:url value="/images/tourHaLong444.jpg"/>" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<c:url value="/images/TourHaLong555.jpg"/>" class="img-responsive" alt="feature-thumb"/></div>
                                </div><!-- end feature-slider-nav -->
                                
                                <ul class="list-unstyled features tour-features">
                                	<li><div class="f-icon"><i class="fa fa-wheelchair"></i></div><div class="f-text"><p class="f-heading">GHẾ NGỒI</p><p class="f-data">${tours.seats}</p></div></li>
                                    <li><div class="f-icon"><i class="fa fa-calendar"></i></div><div class="f-text"><p class="f-heading">THỜI GIAN</p><p class="f-data">${tours.duration}</p></div></li>
                            ...
                            <div class="detail-tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="tour-information" class="tab-pane in active">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<c:url value="/images/hotel-detail-tab-1.jpg"/>" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="flight" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<c:url value="/images/hotel-detail-tab-2.jpg"/>" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                            ...
                            <div class="available-blocks" id="available-tours">
                                    ...
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail.jsp">
                                                <img src="<c:url value="/images/tour-list-1.jpg"/>" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                        ...
                                        <div class="list-info t-list-info">
                                            <h3 class="block-title"><a href="tour-detail.jsp">Orlando</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="tour-detail.jsp" class="btn btn-orange btn-lg">View More</a>
                                         </div><!-- end t-list-info -->
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail.jsp">
                                                <img src="<c:url value="/images/tour-list-2.jpg"/>" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                        ...
                                        <div class="list-info t-list-info">
                                            <h3 class="block-title"><a href="tour-detail.jsp">London</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="tour-detail.jsp" class="btn btn-orange btn-lg">View More</a>
                                         </div><!-- end t-list-info -->
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail.jsp">
                                                <img src="<c:url value="/images/tour-list-3.jpg"/>" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                        ...
                                        <div class="list-info t-list-info">
                                            <h3 class="block-title"><a href="tour-detail.jsp">Australia</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="tour-detail.jsp" class="btn btn-orange btn-lg">View More</a>
                                         </div><!-- end t-list-info -->
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail.jsp">
                                                <img src="<c:url value="/images/tour-list-4.jpg"/>" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                        ...
                                        <div class="list-info t-list-info">
                                            <h3 class="block-title"><a href="tour-detail.jsp">Bangkok</a></h3>
                                            <p class="block-minor">2 Adults, 02 Kids</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="tour-detail.jsp" class="btn btn-orange btn-lg">View More</a>
                                         </div><!-- end t-list-info -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 footer-widget ftr-about">
                            ...
                            <p>“Chúng tôi cam kết luôn nỗ lực đem đến những giá trị dịch vụ tốt nhất cho khách hàng và đối tác để tiếp tục khẳng định vị trí hàng đầu của thương hiệu Lữ hành STARTRAVEL.”</p>
