                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="nav navbar-nav navbar-right navbar-search-link">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Tours<span><i class="fa fa-angle-down"></i></span></a>
                            <ul class="dropdown-menu">
                            	<li><a href="tour-home.jsp">Tour Homepage</a></li>
                                <li><a href="tour-list.jsp">List View Left Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                        ...
                        <div class="collapse sub-menu" id="tours-links">
                            <a href="tour-home.jsp" class="list-group-item">Tour Homepage</a>
                            <a href="tour-list.jsp" class="list-group-item">List View Left Sidebar</a>
                         ...
                         <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-tour-offers">
                                ...
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                    	<a href="tour-detail-right-sidebar.html">
                                        	<img src="<c:url value="/images/tour-1.jpg"/>" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                        <a href="tour-detail-right-sidebar.html">
                                        	<img src="<c:url value="/images/tour-2.jpg"/>" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                        <a href="tour-detail-right-sidebar.html">
                                        	<img src="<c:url value="/images/tour-3.jpg"/>" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                        <a href="tour-detail-right-sidebar.html">
                                        	<img src="<c:url value="/images/tour-4.jpg"/>" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                    	...
                    	<div id="hot-tour-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                	<img src="<c:url value="/images/hot-tour-1.jpg"/>" alt="Los Angeles">
                                </div>
                                
                                <div class="item">
                                	<img src="<c:url value="/images/hot-tour-2.jpg"/>" alt="Chicago">
                                </div>
