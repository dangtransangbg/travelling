...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-search-link">
                        ...
                        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Tours<span><i class="fa fa-angle-down"></i></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="tour-detail.jsp">Detail Left Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                        ...
                        <div class="collapse sub-menu" id="tours-links">
                            ...
                            <a href="tour-detail.jsp" class="list-group-item">Detail Left Sidebar</a>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                            ...
                            <div class="list-block main-block t-list-block">
                            	<div class="list-content">
                            		<div class="main-img list-img t-list-img">
                                        <a href="tour-detail.jsp">
                                            <img src="<c:url value="/images/tour-list-5.jpg"/>" class="img-responsive" alt="tour-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                    ...
                                    <div class="list-info t-list-info">
                                        <h3 class="block-title"><a href="tour-detail.jsp">Newzeland</a></h3>
                                        <p class="block-minor">2 Adults, 02 Kids</p>
                                        <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                        <a href="tour-detail.jsp" class="btn btn-orange btn-lg">View More</a>
                                     </div><!-- end t-list-info -->
                            ...
                            <div class="list-block main-block t-list-block">
                            	<div class="list-content">
                            		<div class="main-img list-img t-list-img">
                                        <a href="tour-detail.jsp">
                                            <img src="<c:url value="/images/tour-list-6.jpg"/>" class="img-responsive" alt="tour-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                    ...
                                    <div class="list-info t-list-info">
                                        <h3 class="block-title"><a href="tour-detail.jsp">Shanghai</a></h3>
                                        <p class="block-minor">2 Adults, 02 Kids</p>
                                        <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                        <a href="tour-detail.jsp" class="btn btn-orange btn-lg">View More</a>
                                     </div><!-- end t-list-info -->
		...
		<script src="<c:url value="/js/custom-price-slider.js"/>"></script>
        <!-- Page Scripts Ends -->
    </body>
</html>
